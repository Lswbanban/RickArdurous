...
const unsigned char MapManager::Level[] PROGMEM = {
	...
	ID(1,1),ID(0,0),ID(15,1),ID(11,0),ID(11,0),ID(0,15),ID(1,11),ID(0,11),ID(0,1),ID(15,15),ID(15,1),
	...
	ID(1,1),ID(3,3),ID(3,3),ID(7,15),ID(8,1),ID(1,1),ID(1,1),ID(3,3),ID(7,15),ID(2,7),ID(3,7),ID(15,3),ID(1,0),
	...
	ID(15,15),ID(15,7),ID(12,15),ID(1,0),ID(12,0),ID(12,12),ID(15,2),ID(1,0),
...
const unsigned int MapManager::LevelLineIndex[] PROGMEM = {0,10,21,26,30,33,37,42,46,62,69,81,89,98,111,124,140,148,152,163,172,181,191,198,208,};
